    ...
    <section class="main-container " >
        ...
        <div>
            ...
            @if($personne->filmsA->count() > 0 || $personne->filmsR->count() > 0 || $personne->filmsP->count() > 0)
                @if($personne->filmsA->count() > 0)
                    @foreach($personne->filmsA as $film)
                        <div class="w-[200px] max-w-sm rounded-lg bg-black">
                            ...
                            <div class="flex  justify-end px-4 pt-4 ">
                                ...
                                <div id="dropdown" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-red-950">
                                    <ul class="py-2" aria-labelledby="dropdownButton">
                                        <li>
                                            <a href="{{route('Films.edit',$film->id)}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Modifier</a>
                                        </li>
                                        {{--<li>
                                            <a href="{{route('Personnes.destroy',$personne->id)}}" class="block px-4 py-2 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Supprimer</a>
                                        </li>--}}
                            ...
                            <a href="{{route('Films.show',$film->id)}}">
                                <div class="flex flex-col items-center pb-10">
                                    ...
                                    <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="{{$film->urlaffiche}}" alt="Affiche du film"/>
                                    <h5 class="indent-0 mb-1 text-xl font-medium text-gray-900 dark:text-red-900 ">{{$film->titre}}</h5>
                                    <span class="" >Rôle : Acteur</span>
                                    <span class="text-sm text-gray-500 dark:text-gray-400">{{ $film->datesortie}}</span>
                                </div>
                            </a>
                        </div>
                    @endforeach
