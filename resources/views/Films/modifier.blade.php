    ...
    <div class="flex-row">
        <form action="{{route('Films.update',$films)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="py-1">
                ...
                <input type="text" name="titre" id="titre" class="inputForm" value="{{$films->titre}}">
            </div>
            <div class="py-1">
                <label for="description">Description : </label>
                <textarea type="text" name="description" id="description" class="inputForm" >{{$films->description}} </textarea>
            </div>
            <div class="py-1">
                <label for="datesortie">date sortie :</label>
                <input type="date" name="datesortie" id="datesortie" class="inputForm" value="{{$films->datesortie}}" >
            </div>

            <div class="py-1">
                <label for="urlaffiche">url affiche : </label>
                <input type="file" class="form-control-file" id="urlaffiche" name="urlaffiche" value="{{$films->urlaffiche}}" >
            </div>
            <div class ="py-1">
                <label for="rating">Rating : </label>
                <input type="text" name="rating" id="rating" class="inputForm" value="{{$films->rating}}">
            </div>
            ...
            <div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="urltrailer" id="urltrailer" class="inputForm" value="{{$films->urltrailer}}">
                    </div>
            ...
            <hr class="w-48 h-1 mx-auto bg-red-800 border-0 rounded  my-2">
            <div>
                <button type="submit" class="btnForm">Modifier</button>
